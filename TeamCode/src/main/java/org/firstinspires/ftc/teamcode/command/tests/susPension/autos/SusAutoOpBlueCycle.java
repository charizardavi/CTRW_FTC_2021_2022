...
@Autonomous(group = "@@@")
@Config
public class SusAutoOpBlueCycle extends LinearOpMode {
    ...
    public static double outakeMaxVeloMod = -10;
    public static double outakeMaxAccelMod = -15;
    ...
    public static int totalCycle = 1; // because of if statement logic
    ...
    State currentState = State.FIRST_OUTAKE;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory cycleIntake = robot.driveRoadRunner.trajectoryBuilder(firstOutake.end(), Math.toRadians(-90))
                .addDisplacementMarker(()->{
            ...
            switch (currentState){
                case FIRST_OUTAKE:
                    if (!robot.driveRoadRunner.isBusy()){
                        ...
                        if( outakeTimer.milliseconds() >= robot.ejectTime ){
                            ...
                            currentState = SusAutoOpBlueCycle.State.INTAKE_CYCLE;
                ...
                case INTAKE_CYCLE:
                    if (!robot.driveRoadRunner.isBusy() && cycleCount < totalCycle){
                        ...
                        currentState = SusAutoOpBlueCycle.State.OUTAKE_CYCLE;
