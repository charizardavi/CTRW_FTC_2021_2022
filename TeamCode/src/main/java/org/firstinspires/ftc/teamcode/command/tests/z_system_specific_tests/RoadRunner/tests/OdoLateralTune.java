package org.firstinspires.ftc.teamcode.command.tests.z_system_specific_tests.RoadRunner.tests;
...
@TeleOp(group = "drive")
public class OdoLateralTune extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (!(robot.driveRoadRunner.getLocalizer() instanceof TrackingWheelLocalizer2021_Scrappy)) {
        ...
        while (!isStopRequested() && !tuningFinished) {
            ...
            robot.driveRoadRunner.setDrivePower(vel);
