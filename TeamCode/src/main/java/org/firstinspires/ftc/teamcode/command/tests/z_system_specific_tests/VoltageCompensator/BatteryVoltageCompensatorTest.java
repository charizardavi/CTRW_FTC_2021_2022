package org.firstinspires.ftc.teamcode.command.tests.z_system_specific_tests.VoltageCompensator;
...
@TeleOp(name = "Battery Voltage Compensator Test", group = "@@T")
@Config


public class BatteryVoltageCompensatorTest extends LinearOpMode{
    // TeleOp Variables
    ...
    public static double FULL_BATTERY_VELO = 3.346877115;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        VoltageCompensator.init(hardwareMap);
        ...
        while (opModeIsActive() && runningOpmode) {
            ...
            double batteryVoltage = VoltageCompensator.getRobotVoltage();
            ...
            if(isRunning){ // add telemetry relating to robot drive mode
                ...
                compensatedPower = VoltageCompensator.compensatePower(motorSpeed);
                mainMotor.setPower( compensatedPower );
            }
            else{
            ...
            telemetry.addData("lowPassFilterCount", VoltageCompensator.tempVar);
