 ...
 */
@Config
public class DriveConstantsSus {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID =  new PIDFCoefficients(11.05, 0, 0.42295, 8.77); // old f code: getMotorVelocityF(MAX_RPM / 60 * TICKS_PER_REV)
  ...
  /*  public static double WHEEL_RADIUS = 1.93; // in   // programming bot values
    ...
    public static double kV = 0.01894;
    public static double kA = 0.016;
    public static double kStatic = 0.005;
    /*
    ...
    public static double MAX_ANG_VEL = Math.toRadians(233.09);
